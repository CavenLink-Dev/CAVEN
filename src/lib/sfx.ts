...
const URLS = {
  ...
  start: new URL("../imports/tap_to_start_open_sound.mp3", import.meta.url)
    .href,
  off: new URL("../imports/tap_to_off_end_sound.mp3", import.meta.url).href,
  success: new URL("../imports/success_activate_sound.mp3", import.meta.url)
    .href,
  notification: new URL("../imports/notification_sound.mp3", import.meta.url)
    .href,
