...
export default function App() {
  return <CoreProvider><main className="app-shell"><TopBar /><div className="board-grid"><div className="board-left"><DailyOverviewCard /><TasksCard /></div><CavenCore /><div className="board-right"><CalendarCard /><RemindersCard /></div></div></main></CoreProvider>
}
