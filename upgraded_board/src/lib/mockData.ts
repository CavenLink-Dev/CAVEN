...
export const tasks: Task[] = [
  {
    id: "t1",
    title: "Send the tenancy email",
    detail: "Draft is waiting. Mercifully short.",
    accent: true,
  },
  { id: "t2", title: "Book a dentist check-up", detail: "10 minutes, tops." },
  {
    id: "t3",
    title: "Water the small jungle",
    detail: "Kitchen shelf · 2 plants",
  },
...
export const calendar = [
  ...
  {
    time: "19:00",
    title: "Pasta with Nia",
    meta: "No preparation required",
    active: false,
  },
]
...
export const reminders = [
  {
    time: "11:45",
    title: "Take a proper lunch",
    note: "Armed · a very sensible idea",
  },
