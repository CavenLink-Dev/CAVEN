...
export function Panel({
  ...
  return (
    <div className={`metal-surface rounded-2xl p-3.5 ${className}`}>
      {title && (
        <div
          className="mb-2.5 font-display t-micro tracking-[0.28em]"
    ...
    >
      <svg width={size} height={size} className="-rotate-90">
        ...
        <circle
          ...
          style={{
            filter: "drop-shadow(0 0 4px var(--caven-glow))",
...
export function Bar({ value }: { value: number }) {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(138,149,165,0.2)" }}
    >
      <div
...
export function Dot({ done }: { done: boolean }) {
  return (
    <span
      ...
      style={{
        border: `1.5px solid ${
          done ? "var(--caven-cyan)" : "rgba(138,149,165,0.4)"
        }`,
